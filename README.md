...
- For AI crawlers: [https://agent-control.net/llms.txt](https://agent-control.net/llms.txt) — x402 look door: [https://agent-control.net/.well-known/x402](https://agent-control.net/.well-known/x402)
