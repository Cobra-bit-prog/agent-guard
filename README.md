...
- Wallet Spend Audit ($49 USDC): [https://agent-control.net/spend-audit](https://agent-control.net/spend-audit)
...
- For AI crawlers: [https://agent-control.net/llms.txt](https://agent-control.net/llms.txt) — MCP: [https://agent-control.net/.well-known/mcp.json](https://agent-control.net/.well-known/mcp.json) — x402 look door: [https://agent-control.net/.well-known/x402](https://agent-control.net/.well-known/x402) — stamp seller recipe: [https://agent-control.net/stamp.txt](https://agent-control.net/stamp.txt)
