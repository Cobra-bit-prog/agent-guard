...
- For AI crawlers: [https://agent-control.net/llms.txt](https://agent-control.net/llms.txt) — MCP: [https://agent-control.net/.well-known/mcp.json](https://agent-control.net/.well-known/mcp.json) — x402 look door: [https://agent-control.net/.well-known/x402](https://agent-control.net/.well-known/x402)
