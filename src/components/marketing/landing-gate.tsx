  ...
  return (
    <section id="sellers" className="border-t border-border">
      <div className="mx-auto max-w-[1140px] px-5 py-16 md:px-6">
        ...
        <h2 className="mt-2 max-w-2xl text-title font-semibold tracking-tight">
        ...
        <blockquote className="mt-6 max-w-2xl rounded-[20px] border border-border bg-surface p-5 text-body leading-relaxed">
