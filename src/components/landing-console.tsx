  ...
  return (
    <div className="mt-10 overflow-hidden rounded-[28px] border border-border bg-surface shadow-[var(--shadow-panel)] landing-rise lg:mt-0">
      <div className="flex items-center gap-2 border-b border-border bg-elevated/60 px-4 py-2.5">
        ...
        <span className="ml-auto font-mono text-meta text-subtle">Demo · sample check</span>
      </div>
      ...
      <div className="flex flex-col items-stretch px-6 py-12 md:px-10 md:py-16">
        <div className="landing-block-card relative w-full overflow-hidden rounded-[22px] border border-border bg-elevated p-7 md:p-10">
          <p className="text-meta font-medium uppercase tracking-[0.14em] text-subtle">
            Pre-sign check
          </p>
          <div className="mt-5 flex items-center gap-2">
            <ChainMark chain="ethereum" className="size-6" />
            <p className="font-mono text-meta text-subtle">Treasury Bot · Ethereum</p>
          </div>
          <p className="mt-5 text-body text-muted">to 0x91c4…a2e1</p>
          <p className="mt-1 font-mono text-display font-medium tabular-nums tracking-tight">
            $2,400
          </p>
          <div className="relative mt-6 min-h-[3.5rem]">
            <div className="landing-check-pending absolute inset-0 flex flex-col justify-center">
              <p className="text-body text-warning">Checking policy…</p>
            ...
            <div className="landing-check-blocked absolute inset-0 flex flex-col justify-center">
              <p className="text-body font-medium text-danger">blocked · over daily cap</p>
              <p className="mt-1 text-meta text-muted">Signature never left the agent.</p>
            </div>
          </div>
        </div>

        <div className="mt-6 flex w-full items-center gap-3 text-body">
          ...
          <span className="font-mono text-meta tabular-nums text-muted">$2,400</span>
        </div>
      </div>
    </div>
  );
