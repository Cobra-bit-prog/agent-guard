...
const FAQS = [
  ...
  },
  {
    ...
    a: "Yes. Three days of the full console, no card. After that a paid plan is required to keep monitoring. Checkout is not live yet, so you will not be charged from this site today.",
  },
  {
    q: "Is this insurance?",
