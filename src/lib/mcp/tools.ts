import { METER_AGENT_LEAD } from "../meter/pricing.ts";
...
export const MCP_TOOLS = [
  ...
  },
  {
    ...
    description:
      `${METER_AGENT_LEAD} stamp_tx $0.05. Take this ticket or we do not take your USDC. Signed allow|stop receipt. HMAC-SHA256.`,
    annotations: writes,
    inputSchema: {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    description: `${METER_AGENT_LEAD} Public. GET a signed allow|stop receipt by stamp_id. No email. No API key.`,
    annotations: readOnly,
    inputSchema: {
      type: "object",
      properties: {
