  ...
  return (
    <SkyShell current="partners">
      <main className="mx-auto max-w-3xl px-6 pb-20 pt-8 md:px-10">
        ...
        <p className="mt-4 max-w-[54ch] text-body leading-snug text-fg">
          A human principal signs up and owns billing and Approval Inbox; agents connect under that
          account.
        </p>

        <section className="mt-12">
          <h2 className="text-title font-semibold tracking-tight">What you are. What we are.</h2>
          <div className="mt-6 space-y-3">
            {POSITIONING.map((row) => (
              ...
              >
                <h3 className="text-card font-medium">{row.them}</h3>
        ...
        <section className="mt-12">
          <h2 className="text-title font-semibold tracking-tight">Why recommend us next to you</h2>
        ...
        <section className="mt-12">
          <h2 className="text-title font-semibold tracking-tight">Minimal integration</h2>
        ...
        <section className="mt-12">
          <h2 className="text-title font-semibold tracking-tight">Partner signup links</h2>
          <p className="mt-3 max-w-[52ch] text-muted">
          ...
          <pre className="mt-5 overflow-x-auto rounded-[16px] bg-[#12263f] p-4 font-mono text-meta leading-relaxed text-[#e8eef6]">
...
https://agent-control.net/signup?partner=agentkit`}
        ...
        <section className="mt-12">
          <h2 className="text-title font-semibold tracking-tight">Pricing</h2>
          <p className="mt-3 max-w-[52ch] text-muted">
