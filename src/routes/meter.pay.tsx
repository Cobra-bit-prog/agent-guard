...
export const Route = createFileRoute("/meter/pay")({
  ...
  head: () => ({
    meta: [
      { title: "Pay 0.10 USDC — Agent Control" },
      {
        name: "description",
        content: "Pay 0.10 USDC on Solana with Phantom. Laptop page — no QR scan required.",
      },
      { name: "theme-color", content: "#eef3f8" },
      { property: "og:title", content: "Pay 0.10 USDC — Agent Control" },
      {
        property: "og:description",
        content: "Pay 0.10 USDC on Solana with Phantom. We unlock when it lands.",
      },
    ],
  }),
});
